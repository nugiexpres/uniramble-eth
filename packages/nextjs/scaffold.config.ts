...
const scaffoldConfig = {
  ...
  // monadTestnet used customChains.ts for ankr rpc. official and alchemy got rate limit,
  ...
  rpcOverrides: {
    // Ankr RPC already set in customChains.ts, no need to override
    // [monadTestnet.id]: "https://rpc.ankr.com/monad_testnet",
  },
