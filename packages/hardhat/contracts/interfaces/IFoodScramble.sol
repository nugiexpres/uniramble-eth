...
interface IFoodScramble {
     ...
     */
    function nameToAddress(string memory username) external view returns (address);
     ...
     */
    function getIngredientTypeAtPosition(uint256 position) external view returns (uint256);
     ...
     */
    function travelHistory(address eoa) external view returns (uint256[] memory);
